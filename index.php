	...
	<section class="presentation">
		<div class="container">
			<div class="presentation-box">
				...
				<div class="row gx-0 ">
					<div class="col-md-8 col-xxl-7 ms-auto">
						<div class="presentation-text">
							...
							<p>
								<strong>Passionnée</strong> par <strong>la créativité</strong> et <strong>le potentiel infini du web</strong>, 
								je suis une développeuse Web et mobile diplômée.<br><br> 
								Mon parcours professionnel varié, notamment dans la gestion de restaurants, 
								m'a permis d'acquérir une solide expérience en<strong> gestion d'équipe</strong>, <strong>organisation d'événements</strong> 
								et conception de supports de communication.<br><br>
								Je suis déterminée à concrétiser ma vision créative et à offrir des expériences numériques uniques. 
					...
					<div class="col-md-6">
						<div class="skill-box position-relative">
							<div class="part-skill part1" onclick="scrollToSkill(1)">
								...
								<a href="#popUp-skill javascript:void(0)" class="common-btn">Développeur web & mobile</a>
							</div>
			...
			<div class="container">
				...
				<div class="col-md-12">
					...
					<p>"Originaire de Corée du Sud et installée en France depuis plusieurs années, 
						...
						<a href="javascript:void(0)" class="common-btn">Lire ma lettre de motivation</a>
					</div>
				</div>
				</div>
			</div>
				...
				<div class="row g-0 left-row">
					...
					<div class="col-md-6">
						<div class="outil-info">
							<div class="outil-box"></div>
							<div class="outil-border"></div>
							<h4>Outils utilisés pour ce site</h4>
								<div class="title-outil">Languages :
